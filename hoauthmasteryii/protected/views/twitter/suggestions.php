 ...
 */
	...
	$suggestionsList = $twitterAdapter ->api()->api('users/suggestions.json');
//	$suggestionsList = $twitterAdapter ->api()->api('users/suggestions/politics-government/members.json');
